...
const columns: ColumnDef<Board>[] = [
  {
    ...
    header: () => (
      <div className="text-left w-[100px] pl-4 text-black font-bold">
        카테고리
      </div>
    ),
    cell: ({ row }) => (
  ...
  {
    accessorKey: "title",
    header: () => <div className="text-left text-black font-bold">제목</div>,
    cell: ({ row }) => (
      <div className="text-left font-medium truncate">{row.original.title}</div>
    ),
    size: 1200,
  },
  {
    accessorKey: "createdAt",
    header: () => <div className="text-right text-black font-bold">작성일</div>,
    cell: ({ row }) => {
